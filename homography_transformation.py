...
while True:
    ...
    if k == ord('s'):
        ...
        cv.imwrite("plan_view.jpg", plan_view)  # Save plan view image
        print("Plan view saved as 'plan_view.jpg'")
    elif k == ord('m'):
        print('merge views')
        merge = merge_views(src, dst)
        cv.imshow("merge", merge)
        cv.imwrite("merged_view.jpg", merge)  # Save merged view image
        print("Merged view saved as 'merged_view.jpg'")
    elif k == 27:
        break
